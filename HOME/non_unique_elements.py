...
How it is used: This mission will help you to understand how to manipulate arrays, something that is the basis for solving more complex tasks. The concept can be easily generalized for real world tasks. 
...
def checkio(data):
    ...
    for i in range(len(data)):
        num2occ[data[i]] += 1
    new_data = [ data[j]   for j in range(len(data))   if num2occ[data[j]] > 1 ]
    return new_data
